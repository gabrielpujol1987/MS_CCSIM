...
OOLL  = [4   5   4   5];	% Overlap size which should be even
...
resultsFolderPath = ['Experiment 2017-04-07 MINCUT MS=' num2str(ms_level) ' nSims=' num2str(nSims) 'x Strebelle\'];
...
% 		ms_level = 2;			% Number of MS level (1, 2, 3).
		...
		experiment_folder_name = ['MS-CCSIM ' num2str(xSize(i)) 'x' num2str(ySize(i)) ' T=' num2str(TT(i)) ' OL=' num2str(OOLL(i)) ' MS=' num2str(ms_level)];
